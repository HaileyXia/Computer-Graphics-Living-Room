...
//  Coursework2
//
//  Created by Hailey on 2021/11/23.
//
...
const GLfloat roomHeight = 7;
const GLfloat roomDepth = 0.1;

const glm::vec2 windowPosition = glm::vec2({ 2, 2 });
const glm::vec2 windowPosition1 = glm::vec2({ -6, 2 });
const glm::vec3 windowDimention = glm::vec3({ 4.1, 3, 0.1 });
...
void buildWindowGlass()
{
    glPushMatrix();
        ...
        drawSolidCuboid(0.1, innerWindowDimentions.y, innerWindowDimentions.z);

        glPushMatrix();
            glTranslatef(0, 0, innerWindowDimentions.x);
            drawSolidCuboid(0.1, innerWindowDimentions.y, innerWindowDimentions.z);
        glPopMatrix();

        glPushMatrix();
            glTranslatef(0, 0, 0.1);
            drawSolidCuboid(innerWindowDimentions.z, 0.1, innerWindowDimentions.x - 0.1);
        glPopMatrix();
        
        glPushMatrix();
            glTranslatef(0, innerWindowDimentions.y - 0.1, 0.1);
            drawSolidCuboid(innerWindowDimentions.z, 0.1, innerWindowDimentions.x - 0.1);
        glPopMatrix();
...
void buildWindow(mat::Material chrome)
{
    glPushMatrix();
        ...
        glTranslatef(-9.7, windowPosition.y, windowPosition.x);
